...
if(!empty($_POST)) {
    ...
    if(empty($err_msg)) {
        ...
        try {
            ...
            $data = array(':page_id' => 1, ':r_date' => date('Y-m-d H:i:s'), ':r_user_id' => $_SESSION['user_id'], ':r_comment' => $comment, ':date' => date('Y-m-d H:i:s'));
            //クエリ実行
            ...
            if($stmt) {
                ...
                header('Location:reviewpage01.php'); //自分自身に遷移する
                exit();
            }
...
<body>
    ...
    <div id='contents' class='site-width'>
        ...
        <div class='area-title'>
            <div class='area-img'>
                <img src="image/main-pic01.jpg" alt="">
            </div>
            <div class='area-text'>
                <h2>生後0ヶ月〜1ヶ月</h2>
                <p>
            ...
            ?>
                        <div class='review-container'>
                            ...
                            <div class='review-favo'>
                                <i class="fas fa-heart js-click-like <?php if(isLike($_SESSION['user_id'], $val['review_id'])) { echo 'active'; } ?>" aria-hidden="true" data-reviewId="<?php echo sanitize($val['review_id']); ?>" ></i>
                            </div>
