...
if(!empty($_POST)) {
    ...
    if(empty($err_msg)) {
        ...
        try {
            ...
            $data = array(':page_id' => 9, ':r_date' => date('Y-m-d H:i:s'), ':r_user_id' => $_SESSION['user_id'], ':r_comment' => $comment, ':date' => date('Y-m-d H:i:s'));
            //クエリ実行
            ...
            if($stmt) {
                ...
                header('Location:reviewpage09.php'); //自分自身に遷移する
                exit();
...
<body>
    ...
    <div id='contents' class='site-width'>
        ...
        <div class='area-title'>
            <div class='area-img'>
                <img src="image/main-pic09.jpg" alt="">
            </div>
            <div class='area-text'>
                <h2>4歳〜6歳</h2>
                <p>
